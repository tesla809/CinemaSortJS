...
var app = function () {
  ...
  document.addEventListener("DOMContentLoaded", function (event) {
    var cinemaSort = require('./cinemaSort');
    var config = require('./config');
    var request = require('superagent');
    // const $ = require('jQuery');

    var feedJsonLink = 'https://content.jwplatform.com/feeds/f49AJ8N4.json';
    var jwKey = config.jwLicense;
    ...
    var createElement = function createElement(element, propertyObj) {
    ...
    var embedPlayer = function () {
      ...
      var jwPlayerScriptSrc = { src: 'js/jwplayer.js' };
      var jwPlayerScriptTag = createElement('script', jwPlayerScriptSrc, '', '');

      var jwPlayerKey = { innerText: "jwplayer.key= " + jwKey };
      var jwPlayerKeyTagLink = createElement('script', jwPlayerKey, '', '');
    }();

    // function to set up one instance of jwplayer
    var playerSetup = function playerSetup(feed, div) {
      var livestreaming = feed.sources[0],
    ...
    var eachVideo = function eachVideo(arrayObj, numOfRow) {
      var containerDiv = document.querySelector('div#row-showcase');
      var videoSplit = arrayObj.length / numOfRow;

      for (var x = 0; x < numOfRow; x++) {
      ...
      var setupJumboTron = function setupJumboTron(arrayObj) {};
    };

    var reqCallback = function reqCallback(error, response) {
      var playlist = JSON.parse(response.text).playlist;
...
},{"./cinemaSort":10,"./config":11,"superagent":2}],10:[function(require,module,exports){
...
// learn how to compile es6 to es5 with grunt.js s
...
// Its a library that makes it easy to create thumbnails and divs of video previews
...
module.exports = {
	jwLicense: 'DCLGMUO1vp5eFkvB8Kta012Px3n4zI2boWKwlg=='
};
